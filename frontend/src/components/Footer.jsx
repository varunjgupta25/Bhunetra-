      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex flex-col text-left">
          <span className="font-bold text-white text-sm">
            भूनेत्रा - महाराष्ट्र राज्य भूमी अभिलेख संगणकीकरण प्रणाली
          </span>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 text-[11px] text-slate-300">
          ...
          <span>|</span>
          <a href="https://mahabhumi.gov.in" target="_blank" rel="noreferrer" className="hover:text-amber-400 underline">महसूल विभाग नियम</a>
          <span>|</span>
          <span className="text-amber-400 font-semibold">हेल्पलाइन: ०२०-२५६५५६३५</span>
        </div>
        ...
        <div className="flex flex-col items-center md:items-end text-[10px] text-slate-400">
          ...
          <span className="text-amber-300 font-medium mt-0.5">
            © २०२६ राष्ट्रीय सूचना विज्ञान केंद्र (NIC) द्वारा विकसित
          </span>
        </div>
      </div>
    </footer>
